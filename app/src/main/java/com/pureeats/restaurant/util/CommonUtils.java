...
import com.pureeats.restaurant.models.CouponDetails;
    ...
    public static void makePhoneCall(Activity activity, String phoneNumber){
        ...
        if(number.trim().length() > 0){
            ...
            if(ContextCompat.checkSelfPermission(activity, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED){
                ActivityCompat.requestPermissions(activity, new String[]{Manifest.permission.CALL_PHONE}, com.pureeats.restaurant.commons.Constants.REQUEST_CALL_ACTIVITY);
            }else{
